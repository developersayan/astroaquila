...
@section('title')
<title>Astroaquila | Add Certificate Price</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Add Certificate Price</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Certificate Price</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.cirtification.add')}}" method="POST" id="cirtificate_form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                               ...
                                               <select class="form-control rm06 basic-select" name="name" id="name">
                                                  ...
                                                  <option value="{{@$value->id}}">{{@$value->cert_name}} ({{@$value->no_of_days}} days)</option>
                                                  @endforeach
                                               </select>
                                    </div>
       ...
       $("#cirtificate_form").validate({
        ...
        submitHandler: function(form){
          ...
          var name = $('#name').val();
           ...
           $.ajax({
                   url:"{{route('admin.manage.cirtification.check.price')}}",
                   method:"GET",
                   ...
                   if (res=="inr_exit") {
                    alert('Base INR price range already exits for this certificate');
                     return false;
                    }
                    else if (res=="usd_exit") {
                      alert('Base USD price range already exits for this certificate');
                     return false;
                    }else{
                      form.submit();
                    }
