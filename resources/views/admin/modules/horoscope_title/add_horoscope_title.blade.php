...
@section('title')
<title>Astroaquila | Add Horoscope Title</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Add Horoscope Title</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Horoscope Title</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.horoscope.title.add')}}" method="POST" id="pujacat" enctype="multipart/form-data">
                                    @csrf
