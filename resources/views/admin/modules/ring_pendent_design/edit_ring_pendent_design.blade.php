...
@section('title')
<title>Astroaquila | Edit Ring Pendent Design</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title"> Edit Ring Pendent Design</h4>
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.manage.ring.pendent.design')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Ring Pendent Design</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form"  method="POST" action="{{route('admin.manage.ring.pendent.design.update')}}" id="design_form" enctype="multipart/form-data">
                                    @csrf
                                  ...
                                  <div class="form-group" style="position: relative;">
                                    <a class="del_image del-custom-class" data-id="{{@$data->id}}" @if(@$data->design_image=='') style="display:none " @endif > <i class="fa fa-times" aria-hidden="true"></i> Delete</a>
                                      <div class="uplodimgfilimg ">
                                                  <em><img src="{{ URL::to('storage/app/public/ring_pendent_design')}}/{{@$data->design_image}}" alt="" id="img2"></em>
                                                </div>
                                        </div>
...
<script type="text/javascript">
  $('.del_image').on('click',function(e){
    ...
    $('#profile_picture').val('');
    $.ajax({
      url:'{{route('admin.manage.ring.pendent.design.delete.image')}}',
      type: "POST",
      data:{
         id:id,
        _token: '{{ csrf_token() }}',
    ...
    $("#icon").change(function () {
            ...
            if (files.length > 0) {
             ...
             <script type="text/javascript">
              ...
              $.ajax({
                      url:"{{route('admin.manage.ring.pendent.design.check')}}",
                      method:"GET",
                      data:{'name':name,'type':type,'id':id},
                      success: function(res) {
                      console.log(res);  
                      if (res=="found") {
                        alert('Design Name Already Added In This Type');
                        return false; 
                     }else{
                      form.submit();
