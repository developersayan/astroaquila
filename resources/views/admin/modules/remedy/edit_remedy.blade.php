...
@section('title')
<title>Astroaquila | Edit Remedy</title>
@endsection
                        ...
                        <div> 
                                ...
                                <div class="panel panel-default panel-fill">
                                    <div class="panel-heading"> 
                                        <h3 class="panel-title">Edit Remedies</h3>

                                    </div> 
                                    <div class="panel-body rm02 rm04"> 
                                        <form role="form" id="remedy_form" action="{{route('admin.manage.update-remedy')}}" method="post">
                                        	@csrf
                                            <input type="hidden" name="id" value="{{@$data->id}}">
                                            <div class="form-group">
                                                <label for="FullName">Remedies name</label>
                                                <input type="text" placeholder="Remedies name" value="{{@$data->remedies_name}}" name="name" class="form-control" id="remedy_name">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <select class="form-control rm06" name="type" id="type_id">
                                                  ...
                                                  <option value="{{@$expertise->id}}" @if (@$data->type_id == @$expertise->id) selected @endif>{{@$expertise->expertise_name}}</option>
                                                  @endforeach
                                               </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" value="{{@$data->price}}" placeholder="Price" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <textarea style="height: 80px" name="description" id="AboutMe" class="form-control">{{@$data->description}}</textarea>
                                            </div>
               ...
               var type_id = $('#type_id').val();
                ...
                var rem_id = '{{@$data->id}}';
              	 $.ajax({
                      ...
                      method:"GET",
                      data:{'type_id':type_id,'remedy_name':remedy_name,'id':rem_id},
