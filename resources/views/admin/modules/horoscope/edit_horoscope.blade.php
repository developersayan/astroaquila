...
@section('title')
<title>Astroaquila | Edit Horoscope</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Horoscope</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Horoscope</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.horoscope.update')}}" method="POST" id="horoscope_form" enctype="multipart/form-data">
                                    @csrf
                                   <input type="hidden" name="id" value="{{@$data->id}}"> 
                                   <div class="form-group ">
                                                <label for="FullName">Horoscope code</label>
                                                <input type="text" placeholder="Horoscope code" id="code" name="code" class="form-control" value="{{@$data->code}}" @if(@$dis) disabled @endif>
                                   ...
                                   <div class="form-group">
                                                 ...
                                                 <select class="form-control rm06 basic-select" name="sub_category_id" id="sub_category_id">
                                                  <option value="">Select Sub Category</option>
                                                   @foreach(@$subcategory as $value)
                                                    <option value="{{@$value->id}}" @if(@$data->sub_category_id==@$value->id) selected @endif>{{@$value->name}}</option>
                                                    @endforeach
                                                 </select>
                                                 <div id="error_category"></div>
                                    </div>
                                    ...
                                    <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder="Horoscope name" id="name" name="name" class="form-control" value="{{@$data->name}}">
                                                <div class="error" id="name_error"></div>
                                     </div>

                                     <div class="form-group rm03">
                                                <label for="AboutMe">Brief about the report</label>
                                                <textarea style="height: 80px"  name="about_report" class="form-control" placeholder="Description" id="description">{{@$data->about_report}}</textarea>
                                                <div class="error" id="brief_error"></div>
                                     </div>

                                     <div class="form-group">
                                                <label for="FullName">Horoscope Price INR</label>
                                                <input type="text" placeholder="Horoscope Price INR" name="price_inr" class="form-control" value="{{@$data->price_inr}}">
                                                <div class="error" id="price_error_inr"></div>
                                    </div>

                                    <div class="form-group">
                                                <label for="FullName">Horoscope Price USD</label>
                                                <input type="text" placeholder="Horoscope Price USD" name="price_usd" class="form-control" value="{{@$data->price_usd}}">
                                                <div class="error" id="price_error_usd"></div>
                                    </div>

                                     <div class="form-group">
                                                <label for="FullName">Discount Percentage In INR (%) </label>
                                                <input type="text" name="discount_inr"  placeholder="Discounted Percentage INR" class="form-control"  value="{{@$data->discount_inr}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="discount_usd"  placeholder="Discounted Percentage USD" class="form-control"  value="{{@$data->discount_usd}}">
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Delivery Days In India" name="delivery_days_india" class="form-control" value="{{@$data->delivery_days_india}}">
                                                <div class="error" id="delivery_days_india_error"></div>
                                            </div>

                                            <div class="form-group">
                                                <label for="FullName">Delivery Days Outside India</label>
                                                <input type="text" placeholder="Delivery Days Outside India" name="delivery_days_outside_india" class="form-control" value="{{@$data->delivery_days_outside_india}}">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group" id="refundable_status_div" @if(@$data->refundable=="N"||@$data->refundable==null) style="display: none;" @endif>
                                                 ...
                                                 <select class="form-control rm06 " name="refundable_status" id="refundable_status">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <select class="chosen-select form-control" multiple="multiple" data-placeholder="Select Expertise" name="expertise[]" id="expertise">
                                                ...
                                                <option value="{{ @$value->id }}" {{ @in_array($value->id,@$selected_expertise)?'selected':''}}>{{@$value->expertise_name}}</option>
                                                @endforeach
                                              </select>
                                            </div>
                                            ...
                                            <div class="clearfix"></div>
                                             <div class="form-group">
                                              <label for="FullName">Horoscope Deliverable</label>
                                                ...
                                                <ul>
                                                  <li>
                                                  <input type="radio" id="radio22"  name="is_deliverable" value="Y" @if(@$data->is_deliverable=="Y") checked @endif>
                                                  <label for="radio22">Yes</label>
                                                </li>
                                                 <li>
                                                <input type="radio" id="radio23"  name="is_deliverable" value="N" @if(@$data->is_deliverable=="N") checked @endif>
                                          ...
                                          <div id="delivery_price" @if(@$data->is_deliverable=="N") style="display: none;" @endif>

                                            <div class="form-group">
                                                <label for="FullName">Delivery Days In India</label>
                                                <input type="number" placeholder="Delivery Days In India" name="delivery_days_india" class="form-control" value="{{@$data->delivery_days_india}}" id="delivery_days_india">
                                                <div class="error" id="delivery_days_india_error"></div>
                                            </div>

                                            <div class="form-group">
                                                <label for="FullName">Delivery Days Outside India</label>
                                                <input type="number" placeholder="Delivery Days Outside India" name="delivery_days_outside_india" class="form-control" value="{{@$data->delivery_days_outside_india}}" id="delivery_days_outside_india">
                                                <div class="error" id="delivery_days_outside_india_error"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" placeholder="Delivery Price INR" name="delivery_price_inr" class="form-control" id="delivery_price_inr" value="{{@$data->delivery_price_inr}}">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="number" placeholder="Delivery Price USD" name="delivery_price_usd" class="form-control" id="delivery_price_usd" value="{{@$data->delivery_price_usd}}">
                                        ...
                                        <div class="clearfix"></div>
                                            <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder="Heading One " name="heading_one" class="form-control new-form" value="{{@$data->heading_one}}">
                                                <div id="error_heading_one"></div>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Description One *</label>
                                                <textarea style="height: 80px"  name="description_one" class="form-control" placeholder="Description One" id="description_one">{{@$data->description_one}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <textarea style="height: 80px"  name="description_two" class="form-control" placeholder="Description Two" id="description_two">{{@$data->description_two}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder="Heading Three " name="heading_three" class="form-control new-form" value="{{@$data->description_three}}">
                                                <div id="error_heading_three"></div>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Description Three *</label>
                                                <textarea style="height: 80px"  name="description_three" class="form-control" placeholder="Description Three" id="description_three">{{@$data->description_three}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder="Heading Four " name="heading_four" class="form-control new-form" value="{{@$data->heading_four}}">
                                                <div id="error_heading_four"></div>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Description Four *</label>
                                                <textarea style="height: 80px"  name="description_four" class="form-control" placeholder="Description Three" id="description_four">{{@$data->description_four}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder="Wealth Predictions based on Vedic Astrology" name="heading_five" class="form-control new-form" id="heading_five" value="{{@$data->heading_five}}">
                                                <div id="error_heading_five" class="error"></div>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Description Five</label>
                                                <textarea style="height: 80px"  name="description_five" class="form-control" placeholder="Description Five" id="description_five">{{@$data->description_five}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder=" Best and Accurate Solutions" name="heading_six" class="form-control new-form" id="heading_six" value="{{@$data->heading_six}}">
                                                <div id="error_heading_six" class="error"></div>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Description Six</label>
                                                <textarea style="height: 80px"  name="description_six" class="form-control" placeholder="Description Six" id="description_six">{{@$data->description_six}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder="Assistance from Experienced Astrologers" name="heading_seven" class="form-control new-form" id="heading_seven" value="{{@$data->heading_seven}}">
                                                <div id="error_heading_seven" class="error"></div>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Description Seven</label>
                                                <textarea style="height: 80px"  name="description_seven" class="form-control" placeholder="Description Seven" id="description_seven"> {{@$data->description_seven}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <input type="text" placeholder="Get Timely Delivery" name="heading_eight" class="form-control new-form" id="heading_eight" value="{{@$data->heading_eight}}">
                                                <div id="error_heading_eight" class="error"></div>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Description Eight</label>
                                                <textarea style="height: 80px"  name="description_eight" class="form-control" placeholder="Description Eight" id="description_eight"> {{@$data->description_eight}}</textarea>
                                            ...
                                            <div class="form-group rm03">
                                                ...
                                                <textarea style="height: 80px"  name="significance" class="form-control" placeholder="Significance" id="significance">{{@$data->significance}}</textarea>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Who/How/When</label>
                                                <textarea style="height: 80px"  name="who_how_when" class="form-control" placeholder="Significance" id="who_how_when">{{@$data->who_how_when}}</textarea>
                                            </div>

                                            {{-- <div class="form-group rm03">
                                                <label for="AboutMe">Related Mantra</label>
                                                <textarea style="height: 80px"  name="related_mantra" class="form-control" placeholder="Significance" id="related_mantra">{{@$data->related_mantra}}</textarea>
                                            </div>

                                            <div class="form-group rm03">
                                                <label for="AboutMe">Usage</label>
                                                <textarea style="height: 80px"  name="usages" class="form-control" placeholder="Usage" id="usages">{{@$data->usages}}</textarea>
                                            </div> --}}
                                       ...
                                       <a class="del_image del-custom-class" data-id="{{@$data->id}}" @if(@$data->image=='') style="display:none " @endif > <i class="fa fa-times" aria-hidden="true"></i> </a>
                                          <div class="uplodimgfilimg ">
                                            <em><img src="{{ URL::to('storage/app/public/horoscope_image')}}/{{@$data->image}}" alt="" id="img2"></em>
                                          </div>
...
<script type="text/javascript">
  $('.del_image').on('click',function(e){
    ...
    $('#profile_picture').val('');
    $.ajax({
      url:'{{route('admin.hororscope.category.delete.image')}}',
      type: "POST",
      data:{
         id:id,
        _token: '{{ csrf_token() }}',
       ...
       ignore: [],     
        ...
        submitHandler: function(form)
        {
            ...
            if ($('#profile_picture').val()=='' &&  $('#image_url').val()=='') {
              alert('Please upload hororscope image');
              return false;
            }
            ...
            if (delivery=="Y" && $('#delivery_days_india').val()==0) {
              alert('Plese enter delivery days in india properly');
              return false;
            }

            if (delivery=="Y" && $('#delivery_days_outside_india').val()==0) {
              alert('Plese enter delivery days outside india properly');
              return false;
            }
...
<script type="text/javascript">
  ...
  $('input[type=radio][name=is_deliverable]').change(function() {
   if (this.value == 'Y') {
    $('#delivery_price').show();
    $("#delivery_price_inr").rules("add", "required");
    $("#delivery_price_usd").rules("add", "required");
    $("#delivery_days_india").rules("add", "required");
    $("#delivery_days_outside_india").rules("add", "required");
   }else{
    $('#delivery_price').hide();
    $("#delivery_price_inr").rules("remove", "required");
    $("#delivery_price_usd").rules("remove", "required");
    $("#delivery_days_india").rules("remove", "required");
    $("#delivery_days_outside_india").rules("remove", "required");
   }
 });
</script>
