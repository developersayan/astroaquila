...
@section('title')
<title>Astroaquila | Edit Category</title>
@endsection
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.modules.manage.horoscope.category.update')}}" method="POST" id="cert_name" enctype="multipart/form-data">
                                    @csrf
       ...
       $("#cert_name").validate({
            rules: {
                name: {
                   required:true,
                   remote: {
                          url:  '{{route('admin.modules.manage.horoscope.category.check')}}',
                          type: "POST",
                          data: {
                            name: function() {
                              return $( "#name").val() ;
