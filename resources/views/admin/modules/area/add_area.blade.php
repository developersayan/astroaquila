...
@section('title')
<title>Astroaquila | Add Area</title>
@endsection
...
<div class="content-page">
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Add Area</h4>
                    ...
                    <div>
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.area.insert')}}" method="POST" id="zipForm" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Area" id="area" class="form-control" name="area" >
