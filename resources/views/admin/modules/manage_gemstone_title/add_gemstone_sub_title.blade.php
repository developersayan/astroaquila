                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.gemstone.title.sub-title-add')}}" method="POST" id="pujacat" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Title" id="subtitle" class="form-control" name="subtitle" required>
