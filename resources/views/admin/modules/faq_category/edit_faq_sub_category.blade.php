...
@section('title')
<title>Astroaquila | Edit Faq Sub Category</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Faq Sub Category</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Faq Sub Category</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.faq.subcategory.update')}}" method="POST" id="category_form" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <select class="form-control rm06  basic-select" name="category" id="category">
                                        ...
                                        <option value="{{@$value->id}}" @if(@$data->parent_id==@$value->id) selected @endif>{{@$value->faq_category}}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Sub Category" id="sub_category" class="form-control" name="sub_category" value="{{@$data->faq_category}}" required>
