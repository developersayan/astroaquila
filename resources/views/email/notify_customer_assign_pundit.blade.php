 ...
 <body style="    font-family: system-ui;">
    ...
    <table style="max-width: 600px; margin: 0 auto; display: block; border:1px solid #e8e8e8">
      ...
      <tbody style="    width: 100%;    display: block; background: url(images/back.png); background-size: cover; background-repeat: no-repeat; background-position: center;">
        ...
        <tr style="    width: 100%;    display: block;">
          <td style="    width: 100%;    display: block;">
            <p style="margin: 0; font-size: 17px; font-weight: 400;   padding: 5px 15px 5px 15px;">Admin has  assigned {{@$data['pundit_name']}} {{@$data['pundit_last']}} as a pundit for your "{{@$data['puja']}} " on <span style="color: #fbbc93; font-weight: 500;">{{@$data['date']}}</span> and order id is "{{@$data['order_id']}}".</p>
          </td>
        </tr>
