...
@section('title')
<title>Astroaquila | Manage Puja Name</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Puja Name</h4>
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.manage.puja.name.add')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Puja </a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading rm02 rm04">
                            <form role="form" action="{{route('admin.manage.puja.name')}}" method="post" id="search_form">
                                @csrf
                                <input type="hidden" name="page" value="" id="page">
                                <div class="form-group">
                                    <label for="FullName">Puja name</label>
                                    <input type="text" id="FullName" class="form-control" value="{{request('name')}}" name="name" placeholder="Puja name">
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('admin.manage.puja.name.edit',['id'=>$value->id])}}">Edit </a></li>
                                                                <li><a href="{{route('admin.manage.puja.name.delete',['id'=>$value->id])}}" onclick="return confirm('Do you want to delete this puja ?')">Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
