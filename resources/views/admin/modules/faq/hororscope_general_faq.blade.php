            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        {{route('admin.manage.faq.product',['id'=>@$id])}} @elseif(@$type=="H") {{route('admin.manage.horoscope.faq',['id'=>@$id])}} @endif"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading rm02 rm04">
                            <form role="form" action="{{route('admin.manage.horoscope.add.general.faq',['id'=>@$id])}}" method="post" id="search_form">
                                @csrf
                         ...
                         <form role="form" action="{{route('admin.manage.faq.horoscope.genral.faq.add')}}" method="post" >
                          @csrf
