...
@section('title')
<title>Astroaquila | Add DataBank</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Add DataBank</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add DataBank</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.data.bank.add')}}" method="POST" id="databank" enctype="multipart/form-data">
                                    @csrf
                                   ...
                                   <div class="form-group ">
                                                ...
                                                <input type="text" placeholder="dob" id="datepicker" name="dob" class="form-control">
                                                <div class="error" id="error_dob"></div>
                                   </div>

                                   <div class="form-group ">
                                                <label for="FullName">Place Of Birth</label>
                                                <input type="text" placeholder="Place Of Birth" id="place_of_birth" name="place_of_birth" class="form-control">
                                   ...
                                   <div class="clearfix"></div>
                                    ...
                                    <div class="form-group rm03">
                                                ...
                                                <textarea style="height: 400px" id="mytextarea" placeholder="Blog   description" class="form-control" name="description"></textarea>
                                    </div>
...
<script type="text/javascript">
    $("#databank").validate({
        ...
        messages: {
          ...
          profession:{
            required:'Please enter the name of profession',
          ...
          famous:{
            required:'Please enter the name of famous for',
