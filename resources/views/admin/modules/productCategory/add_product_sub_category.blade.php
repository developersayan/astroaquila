...
@section('title')
<title>Astroaquila | Add Sub Product Category</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Add Sub Product Category</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Sub Product Category</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.product.sub-category-save')}}" method="POST" id="productCategoryFrom" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Sub category name" id="subcategory" class="form-control" name="subcategory_name" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="uplodimgfil">
                                            ...
                                            <label for="icon">Upload Sub Category Image<img src="{{ URL::to('public/admin/assets/images/clickhe.png')}}" alt=""></label>
                                        </div>
                                       <div id="err_icon"></div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="clearfix"></div>
                                    <div class="form-group rm03">
                                        ...
                                        <textarea style="height: 80px" id="description" class="form-control" name="description" placeholder="Sub category description" ></textarea>
                                    </div>
