...
@section('title')
<title>Astroaquila | Change Password</title>
@endsection
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.change.new.password')}}"  method="POST" id="change_password" enctype="multipart/form-data">
                                    @csrf
                 ...
                 $(function(){
                  ...
                  rules:{
                    oldpassword:{
                      required:true,
                      remote: {
                       url:  '{{route('admin.check.oldpassword')}}',
                       type: "get",
                       data: {
