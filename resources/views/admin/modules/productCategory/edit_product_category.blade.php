...
@section('title')
<title>Astroaquila | Edit Product Category</title>
@endsection
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.product.category.edit.save',['id'=>@$productCategory->id])}}" method="POST" id="productCategoryFrom" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="category_name">Category name</label>
                                        <input type="text" placeholder="Category name" id="category_name" class="form-control" name="category_name"  value="{{$productCategory->name}}">
                                  ...
                                  <div class="form-group" style="position: relative;">
                                        <a class="del_image del-custom-class" data-id="{{@$productCategory->id}}" @if(@$productCategory->image=='') style="display:none" @endif > <i class="fa fa-times" aria-hidden="true"></i> </a>
                                          <div class="uplodimgfilimg uplod_imgem">
                                            <em>
                                             
                                              <img src="{{ URL::to('storage/app/public/product_category_image')}}/{{@$productCategory->image}}" alt="" id="img2"></em>
                                          </div>
                                  ...
                                  {{-- delete --}}
                                   ...
                                   {{-- <div class="form-group">
                                    <div>
                                    <label><a class="del_image" data-id="{{@$productCategory->id}}" @if(@$productCategory->image=='') style="display:none " @endif > <i class="fa fa-times" aria-hidden="true"></i> Delete</a></label>
                                   </div>
                                   </div> --}}
    ...
    $('#croppie-modal').on('hidden.bs.modal', function() {
        ...
        $('#crop-img').click(function() {
            uploadCrop.croppie('result', {
               ...
               //  });
                $('.uplodimgfilimg').show();
                $('.del_image').css('display','block');
                // $('.del-custom-class').css('display','block');
            });
        });
    });
