...
@section('title')
<title>Astroaquila | Manage Seller Signup</title>
@endsection
  ...
  <div class="content-page"> 
    ...
    <div class="content">
      <div class="container"> 
        ...
        <div class="row">
          <div class="col-sm-12">
            <h4 class="pull-left page-title">Manage Seller Signup</h4>
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading rm02 rm04">
                <form role="form" action="{{route('admin.manage.seller.search')}}" method="post" id="search_form">
                 @csrf
                      ...
                      <table class="table">
                        ...
                        @foreach(@$sellers as $seller)
                          <tr>
                            ...
                            <td>
                            	@if(@$seller->file!="")
                            	<a class="btn btn-primary waves-effect waves-light" href="{{route('admin.seller.download.file',@$seller->file)}}">Download</a>
                            	@else
                            	No File 
                            	@endif
                            </td>
                            ...
                            <a href="javascript:void(0);" class="action-dots" id="action{{@$seller->id}}"><img src="{{ URL::to('public/admin/assets/images/action-dots.png')}}" alt=""></a>
                               <div class="show-actions" id="show-{{@$seller->id}}" style="display: none;">
                                ...
                                <ul>
                                    <li><a href="{{route('admin.manage.seller.view',['id'=>@$seller->id])}}">View </a></li>
                                    <li><a href="{{route('admin.manage.seller.delete',['id'=>@$seller->id])}}"  onclick="return confirm('Do you want to delete this seller account?')">Delete</a></li>
                                </ul>
                              </div>
                            </td>
                          </tr>
