...
@section('title')
<title>Astroaquila | Edit City</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit City</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form"  method="POST" action="{{route('admin.manage.city.update')}}" id="stateEdit" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <option value="{{@$value->id}}" @if(@$value->id==@$data->state_id) selected @endif>{{@$value->name}}</option>
                                        @endforeach
                                      </select>
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" placeholder="City name" id="city" class="form-control" name="city" value="{{@$data->name}}" required>
               ...
               submitHandler: function(form){
                ...
                var id = '{{@$data->id}}';
                 $.ajax({
                      ...
                      method:"GET",
                      data:{'state':state,'city':city,'id':id},
