                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-heading" role="tab" id="headingsix">
								...
								<!--<div class="panel-heading" role="tab" id="headingseven">
                                    <h3 class="panel-title"><a @if(@$request['weight']) @else class="collapsed" @endif data-toggle="collapse" href="#collapse_weight" aria-expanded="@if(@$request['weight']) true @else false @endif"
                                            aria-controls="collapse_weight">Weight</a></h3>
                                </div>
                                <div id="collapse_weight" class="panel-collapse collapse @if(@$request['weight']) show @endif" role="tabpanel" aria-labelledby="headingseven">
                                    <div class="diiferent-sec">
                                        <div class="slider_rnge">
                                            <div id="slider-range1" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all">
                                                <div class="ui-slider-range1 ui-widget-header ui-corner-all" style="left: 0%; width: 100%;"></div>
                                                <span tabindex="0" class="ui-slider-handle ui-state-default ui-corner-all" style="left: 0%;"></span>
                                                <span tabindex="0" class="ui-slider-handle ui-state-default ui-corner-all"
                                                    style="left: 100%;"></span>
                                            </div> <span class="range-text">
                                                <input type="text" class="price_numb weightShow" readonly id="weight" name="weight">
                                                <input type="hidden" class="price_numb" readonly id="weight1" name="weight1">
                                                <input type="hidden" class="price_numb" readonly id="weight2" name="weight2">
                                            </span>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 ">
                                <div class="gem-stone-item product_card back_white">
                                    ...
                                    <div class="gem-stone-text">
                                        ...
                                        <p>{!! substr(@$product->description, 0, 35 ) . '...' !!}</p>
                                        @else
                                        <p>
                                            {!! @$product->description !!}
                                        </p>
