...
@section('title')
<title>Astroaquila | Add Category</title>
@endsection
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.modules.manage.horoscope.category.insert')}}" method="POST" id="cert_name" enctype="multipart/form-data">
                                    @csrf
