...
@section('title')
<title>Astroaquila | Edit Blog Category</title>
@endsection
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.update-blog-category')}}" method="POST" id="blogcategory" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="cat_id" value="{{@$category->id}}">
                                    <div class="form-group">
                                        <label for="category_name">Category name</label>
                                        <input type="text" placeholder="Category name" id="category_name" class="form-control" name="category_name" value="{{@$category->category}}">
