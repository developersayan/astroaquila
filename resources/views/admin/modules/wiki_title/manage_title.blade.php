...
@section('title')
<title>Astroaquila | Manage Wiki Title</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Wiki Title</h4>
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.manage.wiki.title.add-view')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Wiki Title</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading rm02 rm04">
                            <form role="form" action="{{route('admin.manage.wiki.title')}}" method="post" id="search_form">
                                @csrf
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$value->title}}</td>
                                                    <td>@if(@$value->image!="")<img src="{{ URL::to('storage/app/public/wiki_title')}}/{{@$value->image}}" class="widthimg80"> @else No Image @endif</td>
                                                   <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('admin.manage.wiki.title.edit',['id'=>$value->id])}}">Edit </a></li>
                                                                <li><a href="{{route('admin.manage.wiki.title.delete',['id'=>$value->id])}}" onclick="return confirm('Do you want to delete this title ?')">Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
