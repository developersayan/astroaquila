...
@section('title')
<title>Astroaquila | Edit Language</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Language</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.language.update')}}" method="POST" id="cert_name" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{@$data->id}}">
                                    <div class="form-group">
                                        <label for="category_name">Language Name</label>
                                        <input type="text" placeholder="Language Name" id="name" class="form-control" name="name" required value="{{@$data->language_name}}">
