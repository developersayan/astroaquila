...
@section('title')
<title>Astroaquila | Add Ring Pendent Design</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title"> Add Ring Pendent Design</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Ring Pendent Design</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form"  method="POST" action="{{route('admin.manage.ring.pendent.design.add')}}" id="design_form" enctype="multipart/form-data">
                                    @csrf
