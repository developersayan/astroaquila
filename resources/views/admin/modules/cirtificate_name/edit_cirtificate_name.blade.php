...
@section('title')
<title>Astroaquila | Edit Certificate Name</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Certificate Name</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Certificate Name</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.cirtificate.name.update')}}" method="POST" id="cert_name" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{@$data->id}}">
                                    <div class="form-group">
                                        <label for="category_name">Certificate Name</label>
                                        <input type="text" placeholder="Certificate Name" id="name" class="form-control" name="name" value="{{@$data->cert_name}}" required>
                                        {{-- <div id="err_category"></div> --}}
                                    </div>

                                    <div class="form-group">
                                        <label for="category_name">No. of days required for Testing</label>
                                        <input type="text" placeholder="No. of days required for Testing" id="days" class="form-control" name="days" required value="{{@$data->no_of_days}}">
                                     </div>
