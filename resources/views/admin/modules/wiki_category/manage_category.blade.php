...
@section('title')
<title>Astroaquila | Manage Wiki Category</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Wiki Category</h4>
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.manage.wiki.category.add-view')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Category</a></li>
                        <li class="active"><a href="{{route('admin.manage.wiki.sub-category.add-view')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Sub Category</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading rm02 rm04">
                            <form role="form" action="{{route('admin.manage.wiki.category')}}" method="post" id="search_form">
                                @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>@if($value->parent_id==0)--@else{{@$value->parent->name}}@endif</td>
                                                     <td>@if(@$value->image!="")<img src="{{ URL::to('storage/app/public/wiki_category')}}/{{@$value->image}}" class="widthimg80"> @else No Image @endif</td>
                                                   <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('admin.manage.wiki.category.edit-view',['id'=>$value->id])}}">Edit </a></li>
                                                                <li><a href="{{route('admin.manage.wiki.category.delete',['id'=>$value->id])}}" onclick="return confirm('Do you want to delete this category ?')">Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
