...
@section('title')
<title>Astroaquila | Edit Banner Image</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Banner Image</h4>
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.manage.home.page.banner.second')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Banner Image</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.home.page.banner.update.second')}}" method="POST" id="image_form" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="uplodimgfil">
                                            <input type="file" accept="image/*" name="image" id="image" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" onchange="fun1()" />
                                  ...
                                  <div class="form-group rm03">
                                        <label for="Email">Previous Banner Image</label>
                                  <div class="uplodimgfilimg">
                                   
                                  <img src="{{ URL::to('storage/app/public/banner_image')}}/{{@$data->image}}" alt="" id="img3" style="height: 250px;width: 350px !important;">
