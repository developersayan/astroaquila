                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading rm02 rm04">
                            <form role="form" action="{{route('admin.manage.faq.puja.genral.faq.view',['id'=>@$id])}}" method="post" id="search_form">
                                @csrf
                         ...
                         <form role="form" action="{{route('admin.manage.faq.puja.genral.faq.add')}}" method="post" >
                          @csrf
