...
@section('title')
<title>Astroaquila | Change Profile</title>
@endsection
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form"  method="POST" action="{{route('admin.update.profile')}}" id="profile_form" enctype="multipart/form-data">
                                    @csrf
                                  ...
                                  <div class="uplodimgfilimg">
                                    <em>
                                  <img src="{{ URL::to('storage/app/public/profile_picture')}}/{{auth()->guard('admin')->user()->profile_pic}}" alt="" id="img2">
                                  </em>
                                </div>  
