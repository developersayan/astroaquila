...
@section('title')
<title>Astroaquila | Manage Home Page First Slider</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Home Page First Slider</h4>
                    ...
                    <li class="active"><a href="{{route('admin.settings.sub.menu')}}"><i
                     ...
                     <ol class="breadcrumb pull-right" id="add_image_icon" @if(@$data->setting_type=="I") style="display: block;" @else style="display: none;" @endif>
                        <li class="active"><a href="{{route('admin.manage.home.page.banner.add-image')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Images</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                             <form action="{{route('admin.manage.home.page.banner.save.settings')}}" method="post">
                              @csrf        
                              <div class="col-lg-4">          
                        ...
                        <div class="panel panel-default panel-fill" id="video_details" @if(@$data->setting_type=="V") style="display: block;" @else style="display: none;" @endif>
                            <div class="panel-heading">
                                ...
                                <div class="panel-body rm02 rm04">
                                    <form role="form" action="{{route('admin.manage.home.page.banner.video-upload')}}" method="POST" id="video_form" enctype="multipart/form-data">
                                        @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>                                                                
                                                                <li><a href="{{route('admin.manage.home.page.banner.edit',['id'=>@$value->id])}}">Edit</a></li>
                                                                
                                                                <li><a href="{{route('admin.manage.home.page.banner.delete',['id'=>@$value->id])}}"  onclick="return confirm('Do you want to delete this ?')">Delete</a></li>
