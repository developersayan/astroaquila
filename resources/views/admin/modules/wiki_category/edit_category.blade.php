...
@section('title')
<title>Astroaquila | Edit Wiki Category</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Wiki Category</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Wiki Category</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.wiki.category.update')}}" method="POST" id="cert_name" enctype="multipart/form-data">
                                    @csrf
       ...
       $("#cert_name").validate({
            rules: {
                name: {
                   required:true,
                   remote: {
                          url:  '{{route('admin.manage.wiki.category.check')}}',
                          type: "POST",
                          data: {
                            name: function() {
                              return $( "#name").val() ;
