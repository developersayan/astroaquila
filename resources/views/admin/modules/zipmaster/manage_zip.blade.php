...
@section('title')
    <title>Astroaquila | Manage ZipCode</title>
@endsection
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title">Manage Zip</h4>
                        <ol class="breadcrumb pull-right">
                            <li class="active"><a href="{{ route('admin.add.zip.view') }}"><i class="fa fa-plus"
                                        aria-hidden="true"></i> Add Zip</a></li>

                            <li class="active" ><a href="{{ route('admin.manage.zipcode.upload') }}"><i class="fa fa-file-excel-o"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading rm02 rm04">
                                <form role="form" action="{{ route('admin.manage.zip.search') }}" method="post"
                                    id="search_form">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="FullName">Search By Postcode</label>
                                        <input type="text" id="FullName" class="form-control"
                                            value="{{ request('name') }}" name="name" placeholder="Post Code">
                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="rm07">
                                                                    ...
                                                                    <div class="show-actions"
                                                                        ...
                                                                        <ul>
                                                                            <li><a
                                                                                    href="{{ route('admin.zip.edit.view', ['id' => $value->id]) }}">Edit
                                                                                </a></li>
                                                                            <li><a href="{{ route('admin.zip.delete', ['id' => $value->id]) }}"
