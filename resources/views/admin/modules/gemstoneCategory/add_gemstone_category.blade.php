...
@section('title')
<title>Astroaquila | Add Gemstone Category</title>
@endsection
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.gemstone.category.manage')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Gemstone Category</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.gemstone.category.add.save')}}" method="POST" id="gemstoneCategoryFrom" enctype="multipart/form-data">
                                    @csrf
