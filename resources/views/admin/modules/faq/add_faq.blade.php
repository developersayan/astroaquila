...
@section('title')
<title>Astroaquila | Add General Faq</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Add General Faq</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add General Faq</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.general.faq.add')}}" method="POST" id="faq_form" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                               ...
                                               <select class="form-control rm06 basic-select" name="type" id="type">
                                                  ...
                                                  <option value="PU">Puja</option>
                                                  <option value="H">Horoscope</option>
                                                  <option value="A">Astrologer</option>
                                                  <option value="D">Aquila Data Bank</option>
                                               </select>
