...
@section('title')
<title>Astroaquila | Edit Puja Energization</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Puja Energization</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Puja Energization</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.puja-energization.update')}}" method="POST" id="ringForm" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                               ...
                                               <select class="form-control rm06 basic-select" name="name" id="name">
                                                  ...
                                                  <option value="{{@$value->id}}" @if(@$data->puja_id==@$value->id) selected @endif>{{@$value->puja}}</option>
                                                  @endforeach
                                               </select>
                                    </div>
...
<script>
    $(document).ready(function(){
       $("#ringForm").validate({
        ...
        messages: {
                name: {
                    required:'Please enter puja energization name',
          ...
          var id = '{{@$data->id}}';
           $.ajax({
                   url:"{{route('admin.manage.puja-energization.check-price-edit')}}",
                   method:"GET",
