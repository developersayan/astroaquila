  ...
  <body style="margin:0; padding:0;">
    ...
    @if(@$data['type']=="H")
      ...
      <ul style="margin:0; padding:0; width: 100%; float: left;">
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Order Number :{{$data['order']->order_id}}</strong></li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Order Date :{{ date('jS M Y',strtotime(@$data['order']->date))}}</strong></li>

        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Horoscope Name :{{ @$data['order']->horoscope->name }}</strong></li>

        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Horoscope Code :{{ @$data['order']->horoscope->code }}</strong></li>

        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Person Name :{{ @$data['order']->name }}</strong></li>

        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Person Email :{{ @$data['order']->email }}</strong></li>

        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Person Number :{{ @$data['order']->phone_no }}</strong></li>
        @if(@$data['order']->gender == 'M')
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Person Gender :Male</strong></li>
        @elseif(@$data['order']->gender == 'F')
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Person Gender :Female</strong></li>
        @else
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Person Gender :Others</strong></li>
        @endif

        @if(@$data['order']->no_dob == 'N')
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Date Of Birth :{{date('d/m/Y',strtotime(@$data['order']->dob))}}</strong></li>
        @endif

        @if(@$data['order']->no_dob_time == 'N')
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Time Of Birth :{{date('H:i a',strtotime(@$data['order']->dob_time))}}</strong></li>
        @endif

        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Place Of Birth :{{@$data['order']->place}}</strong></li>

        @if(@$data['order']->country_id !="" && @$data['order']->country_id !=0)
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Country:{{@$data['order']->country_horoscope->name}}</strong></li>
        @endif



        @if(@$data['order']->problem_question !="")
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;"><strong>Question :{{@$data['order']->problem_question}}</strong></li>
        @endif
        ...
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Order Total  : {{@$data['order']->currencyDetails->currency_code}} {{@$data['order']->total_rate}} </strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Payment Status  : @if(@$data['order']->payment_status=='I') Initiated @elseif(@$data['order']->payment_status=='P') Paid @elseif(@$data['order']->payment_status=="F") Failed @endif </strong>
        </li>
        @if(@$data['order']->horoscope_delivery=="Y")
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Tentative Deliver Date  : {{ date('jS M Y',strtotime(@$data['order']->horoscope_delivery_date))}} </strong>
        </li>
        @endif
      </ul>
...
@if(@$data['order']->horoscope_delivery=="Y")
      ...
      <ul style="margin:0; padding:0;">
        ...
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>City:{{ @$data['order']->city->name }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Zip Code:{{ @$data['order']->shipping_pin_code }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Land Mark:{{ @$data['order']->shipping_landmark }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Street:{{ @$data['order']->shipping_street }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Country:{{ @$data['order']->country->name }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>State:{{ @$data['order']->state->name }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Address:{{ @$data['order']->shipping_address }}</strong>
        </li>
    ...
    <div class="order_d_block" style="width:96.5%; float:left; border:1px solid #ddd; padding:10px; margin-bottom:10px;">
      ...
      <ul style="margin:0; padding:0; width: 45%; float: right;">
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Order Total  : {{@$data['data']->horoscope->name->currency_code}} {{@$data['data']->total_rate}} </strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>Payment Status  : @if(@$data['data']->payment_status=='I') Initiated @elseif(@$data['data']->payment_status=='P') Paid @elseif(@$data['data']->payment_status=="F") Failed @endif </strong>
        </li>
      </ul>
    </div>
    <div class="half_ddiv" style="width:45.2%; float:left; border:1px solid #ddd; padding:10px; margin-bottom:10px; margin-right: 17px;">
      ...
      <ul style="margin:0; padding:0;">
        ...
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>City:{{ @$data['data']->city->name }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
    ...
    <div class="half_ddiv" style="width:45.2%; float:left; border:1px solid #ddd; padding:10px; margin-bottom:10px;">
      ...
      <ul style="margin:0; padding:0;">
        ...
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
            <strong>City:{{ @$data['data']->billingCity->name }}</strong>
        </li>
        <li style="list-style:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; margin-bottom:5px; margin-left: 0px;">
        ...
        <table cellpadding="0" cellspacing="0" style="margin:15px 0 0; padding:0; width:100%; float:left;">
          ...
          <tr>
            <td style="padding:7px 4px; color:#323232; font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:center; border-bottom:1px solid #ddd;"  >
              ...
              @endif
              <br>
              <p style="margin: 5px 0; float: left; text-align: left;">
               ...
               @if($value->product_type=='GS' && @$value->jewellery_type && @$value->metal_type) With @if(@$value->metal_type=='G') Gold @elseif(@$value->jewellery_type=='S') Silver @elseif(@$value->jewellery_type=='P') Panchdhatu @endif  @if(@$value->jewellery_type=='R') Ring @elseif(@$value->jewellery_type=='P') Pendant @elseif(@$value->jewellery_type=='B') Bracelet @endif @endif</p>
