...
@section('title')
<title>Astroaquila | Edit Puja Category</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Puja Category</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Puja Category</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.update-puja-category')}}" method="POST" id="pujacat" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{@$data->id}}">
                                    <div class="form-group">
                                        <label for="category_name">Category name</label>
                                        <input type="text" placeholder="Category name" id="category_name" class="form-control" name="category_name" value="{{@$data->name}}">
       ...
       $("#pujacat").validate({
            rules: {
                category_name: {
                   required:true,
                   remote: {
                          url:  '{{route('admin.manage.check-puja-category')}}',
                          type: "POST",
                          data: {
