...
@section('title')
<title>Astroaquila | Edit  Faq</title>
@endsection
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.faq.update')}}" method="POST" id="faq_form" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group rm03">
                                              <label for="AboutMe">Answer</label>
                                                <textarea style="height: 150px" name="answer" id="answer" class="form-control">{{@$data->answer}}</textarea>
                                     </div>
